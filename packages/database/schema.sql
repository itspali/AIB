...
CREATE TABLE purchase_orders (
    ...
    shipping_amount         NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    shipping_tax_rate_pct   NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    shipping_tax_amount     NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    shipping_tax_type       TEXT NOT NULL DEFAULT 'percent',
    round_off_amount        NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    additional_charges_amount NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    transaction_discount_percentage NUMERIC(5, 2) NOT NULL DEFAULT 0.00,
    transaction_discount_amount     NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    transaction_discount_type       TEXT NOT NULL DEFAULT 'percent',
...
CREATE TABLE sales_quotations (
    ...
    origin_location_id  UUID REFERENCES tenant_locations (id) ON DELETE RESTRICT,
    ...
    prices_tax_inclusive BOOLEAN NOT NULL DEFAULT FALSE,
    tax_supply_nature   TEXT NOT NULL DEFAULT 'INTERSTATE',
    tax_mechanism       gst_tax_mechanism NOT NULL DEFAULT 'FORWARD',
    customer_tax_treatment tax_treatment_type,
...
CREATE TABLE sales_invoices (
    ...
    transaction_discount_percentage NUMERIC(5, 2) NOT NULL DEFAULT 0.00,
    transaction_discount_amount NUMERIC(15, 4) NOT NULL DEFAULT 0.0000,
    ar_posted_at            TIMESTAMPTZ,
    gl_tax_posted_at        TIMESTAMPTZ,
    custom_fields           JSONB NOT NULL DEFAULT '{}'::jsonb,
    created_by              UUID NOT NULL REFERENCES users (id) ON DELETE RESTRICT,
    created_at              TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at              TIMESTAMPTZ NOT NULL DEFAULT NOW(),
