-- Document-level charges on purchase order headers (shipping, shipping tax, round-off, additional).

ALTER TABLE public.purchase_orders
    ADD COLUMN IF NOT EXISTS shipping_amount NUMERIC(15, 4) NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS shipping_tax_rate_pct NUMERIC(15, 4) NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS shipping_tax_amount NUMERIC(15, 4) NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS shipping_tax_type TEXT NOT NULL DEFAULT 'percent',
    ADD COLUMN IF NOT EXISTS round_off_amount NUMERIC(15, 4) NOT NULL DEFAULT 0,
    ADD COLUMN IF NOT EXISTS additional_charges_amount NUMERIC(15, 4) NOT NULL DEFAULT 0;

ALTER TABLE public.purchase_orders
    DROP CONSTRAINT IF EXISTS purchase_orders_shipping_tax_type_chk;

ALTER TABLE public.purchase_orders
    ADD CONSTRAINT purchase_orders_shipping_tax_type_chk
    CHECK (shipping_tax_type IN ('percent', 'amount'));
