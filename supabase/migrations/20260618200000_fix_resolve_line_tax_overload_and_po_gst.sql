-- ====================================================================
-- Fix ambiguous resolve_line_tax overload + restore GST on PO save
-- Migration: 20260618200000_fix_resolve_line_tax_overload_and_po_gst.sql
--
-- The GST migration added a 7-parameter resolve_line_tax but did not drop
-- the prior 6-parameter overload. Calls with 6 args then match both.
-- The header-charges migration also regressed save_purchase_order away
-- from gst_resolve_supply_context.
-- ====================================================================
