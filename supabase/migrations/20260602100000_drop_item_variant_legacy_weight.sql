-- Consolidate legacy item_variants.weight into dead_weight_kg and drop the duplicate column.
-- Migration: 20260602100000_drop_item_variant_legacy_weight.sql

UPDATE public.item_variants
SET dead_weight_kg = weight
WHERE COALESCE(dead_weight_kg, 0) = 0
