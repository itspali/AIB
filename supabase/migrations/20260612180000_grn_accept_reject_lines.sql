-- GRN line accept/reject quantities from JSON payload
-- Migration: 20260612180000_grn_accept_reject_lines.sql
...
-- Patch post_goods_receipt to honor quantity_accepted / quantity_rejected on each line.
