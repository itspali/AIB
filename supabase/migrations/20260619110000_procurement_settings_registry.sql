-- Allow PROCUREMENT_SETTINGS (and THEME_SETTINGS) in tenant workspace control upsert/clear.
-- Organization settings persist procurement flags via upsert_tenant_workspace_control.
