-- Migration: search_filter_engine
...
CREATE INDEX search_telemetry_logs_tenant_created_idx
...
CREATE INDEX search_filter_violations_tenant_created_idx
                            ...
                            WHEN 'FIELD_GT' THEN
                                CASE clause ->> 'left'
                                    WHEN 'purchase_price' THEN
                                        CASE clause ->> 'right'
                                            WHEN 'selling_price' THEN pcsr.purchase_price > pcsr.selling_price
                                            ELSE FALSE
                                        END
                                    ELSE FALSE
                                END
