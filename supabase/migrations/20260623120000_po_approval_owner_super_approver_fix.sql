-- ====================================================================
-- PO approval: workspace owner super-approver bypass (re-apply)
-- Migration: 20260623120000_po_approval_owner_super_approver_fix.sql
--
-- The 20260622130000 version slot was taken by supplier_portal, so
-- po_approval_super_approver_threshold never ran. Owners were still
-- blocked from self-approving above-threshold POs.
-- ====================================================================
