...
export const LIST_MODULE_PAGE_CHROME =
  "z-20 shrink-0 overflow-visible border-b border-border/80 bg-background -mx-3 px-3 pt-2 pb-0.5 md:-mx-4 md:px-4 md:pt-2.5 md:pb-1 lg:-mx-6 lg:px-6 lg:pt-3";
