...
const DOCUMENT_TEMPLATES_SETTINGS_PATH = SETTINGS_ROUTES.presentationDocuments;
...
export async function savePurchaseOrderDocumentLayout(
  ...
  return saveDocumentLayoutForModule(
    ...
    [SETTINGS_ROUTES.operationsProcurement, DOCUMENT_TEMPLATES_SETTINGS_PATH, "/procurement/purchase-orders"],
    input
  );
}
...
export async function saveGoodsReceiptDocumentLayout(
  ...
  return saveDocumentLayoutForModule(
    ...
    [SETTINGS_ROUTES.operationsProcurement, DOCUMENT_TEMPLATES_SETTINGS_PATH, "/procurement/goods-receipts"],
    input
  );
}
...
export async function savePurchaseInvoiceDocumentLayout(
  ...
  return saveDocumentLayoutForModule(
    ...
    [SETTINGS_ROUTES.operationsProcurement, DOCUMENT_TEMPLATES_SETTINGS_PATH, "/procurement/bills"],
    input
  );
}
