...
export function FulfillmentShippingCatalogPageSkeleton() {
  return (
    <div
      ...
      <div className={LIST_MODULE_PAGE_CHROME}>
        <div className="space-y-2.5">
          <div className="flex items-center justify-between gap-2.5">
            ...
            <Skeleton className="h-8 w-32 shrink-0 rounded-md shimmer" />
          </div>
          <Skeleton className="h-7 w-full max-w-xl shimmer" />
        </div>
      </div>
