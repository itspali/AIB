...
export function SalesOrderDocumentLayoutPanel(props: Props) {
  return (
    <DocumentLayoutPanel
      adapter={DOCUMENT_LAYOUT_MODULE_ADAPTERS.SALES_ORDER}
      loadLayout={loadSalesOrderDocumentLayout}
      saveLayout={saveSalesOrderDocumentLayout}
      {...props}
    />
  );
}
