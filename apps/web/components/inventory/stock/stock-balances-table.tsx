...
import { renderStockBalanceListCell } from "@/components/inventory/stock/stock-balance-list-cells";
...
import { getStockBalanceCellDisplayTexts } from "@/lib/inventory/stock/list-column-display-text";
import {
                  ...
                  return (
                    <th
                      ...
                      className={cn(
                        ...
                        !onAdjust && listTableHeaderCornerClass(index, lastDataColumnIndex)
                      )}
            ...
            <tbody>
              {rows.map((row) => {
                ...
                return (
                  <tr
                    key={row.id}
                    className={listTableRowClass(selected, Boolean(onSelect))}
                  ...
                  >
                    {columns.map((columnId, index) => {
                      ...
                      return (
                        ...
                        >
                          {renderStockBalanceListCell(columnId, row)}
                        </td>
                      );
                    })}
                    {onAdjust ? (
